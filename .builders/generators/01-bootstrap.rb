KManager.action :bootstrap do
  action do
    application_name = :k_playground_gpt
    ...
    director = KDirector::Dsls::RubyGemDsl
      ...
      .data(
        ...
        application_description:    'GPT playground',
        ...
        application_lib_namespace:  'KPlaygroundGpt',
        namespaces:                 ['KPlaygroundGpt'],
        author:                     'David Cruwys',
        author_email:               'david@ideasmen.com.au',
        initial_semver:             '0.0.1',
        main_story:                 'As a developer, I want quickly test ChatGPT concepts, so that I can stay ahead of the curve',
        copyright_date:             '2022',
        website:                    'http://appydave.com/gems/k_playground_gpt'
      )
      .github(
        active: false,
...
KManager.opts.app_name                    = 'k_playground_gpt'
